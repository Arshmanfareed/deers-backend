                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="field">
                                                ...
                                                <input value="{{$id->name}}" type="text" class="form-control" id="dept_name" name="name" placeholder="Department">
                                                @error('name')
                                        ...
                                        <div class="col-12">
                                            <div class="field address">
                                                ...
                                                <input value="{{$id->address}}" type="text" class="form-control" id="address" name="address" placeholder="Complete address">
                                                @error('address')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="field">
                                                ...
                                                <input value="{{$id->phone}}" type="number" class="form-control" id="phone_number" name="phone" placeholder="+012 345 6789" autocomplete="off" required>
                                                @error('phone')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="field">
                                                ...
                                                <input value="{{$id->email}}" type="email" class="form-control" id="email" name="email" placeholder="Enter Email" autocomplete="off">
                                                @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="field d-flex">
                                                <p>Status</p>
                                                <label class="switch">
                                                    <input name="status" class="toggleButton" type="checkbox" {{ $id->status == 'on' ? 'checked' : '' }} >
